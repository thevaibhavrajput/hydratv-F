...
const Home = () => {
  ...
  return (
    <div className="relative">
      <Helmet>
        <title>
          Watch Anime Online, Free Anime Streaming Online on HydraTv Anime
          Website
        </title>
        <meta
          name="description"
          content=" HydraTv to is a free no ads anime site to watch free anime. Online anime streaming at HydraTv with DUB, SUB in HD HydraTv.shop."
        />
        <meta property="og:title" content="home - HydraTv" />
      </Helmet>
      {isLoading ? (
